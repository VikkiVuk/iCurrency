...
import xyz.vikkivuk.icurrency.network.WithdrawGuiButtonMessage;
...
public class WithdrawGuiScreen extends AbstractContainerScreen<WithdrawGuiMenu> {
	private final static HashMap<String, Object> guistate = WithdrawGuiMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	EditBox amount;

	public WithdrawGuiScreen(WithdrawGuiMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("icurrency:textures/withdraw_gui.png");
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 52, this.topPos + 52, 67, 20, new TextComponent("Withdraw"), e -> {
			if (true) {
				IcurrencyMod.PACKET_HANDLER.sendToServer(new WithdrawGuiButtonMessage(0, x, y, z));
				WithdrawGuiButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		}));
	}
}
