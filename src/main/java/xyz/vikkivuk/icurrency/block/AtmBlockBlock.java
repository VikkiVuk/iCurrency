...
package xyz.vikkivuk.icurrency.block;
...
public class AtmBlockBlock extends Block {
	public static final DirectionProperty FACING = HorizontalDirectionalBlock.FACING;

	public AtmBlockBlock() {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(IcurrencyModBlocks.ATM_BLOCK.get(), renderType -> renderType == RenderType.cutout());
	}
}
