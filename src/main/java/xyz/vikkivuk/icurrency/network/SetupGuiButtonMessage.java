...
import xyz.vikkivuk.icurrency.procedures.SetupProcedureProcedure;
...
public class SetupGuiButtonMessage {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			SetupProcedureProcedure.execute(entity, guistate);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		IcurrencyMod.addNetworkMessage(SetupGuiButtonMessage.class, SetupGuiButtonMessage::buffer, SetupGuiButtonMessage::new,
				SetupGuiButtonMessage::handler);
	}
}
