...
import xyz.vikkivuk.icurrency.procedures.OpenATMWithdrawProcedure;
import xyz.vikkivuk.icurrency.procedures.OpenATMPayProcedure;
import xyz.vikkivuk.icurrency.procedures.OpenATMDepositProcedure;
...
public class AtmGuiButtonMessage {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 2) {
			...
			OpenATMPayProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		IcurrencyMod.addNetworkMessage(AtmGuiButtonMessage.class, AtmGuiButtonMessage::buffer, AtmGuiButtonMessage::new,
				AtmGuiButtonMessage::handler);
	}
}
