...
public class WithdrawMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public WithdrawMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MenuRegistry.WITHDRAW_GUI, id);
