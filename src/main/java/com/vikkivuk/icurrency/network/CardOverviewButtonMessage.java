...
public record CardOverviewButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(IcurrencyMod.MODID, "card_overview_buttons");

	public CardOverviewButtonMessage(FriendlyByteBuf buffer) {
	...
	public static void handleData(final CardOverviewButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		IcurrencyMod.addNetworkMessage(CardOverviewButtonMessage.ID, CardOverviewButtonMessage::new, CardOverviewButtonMessage::handleData);
	}
