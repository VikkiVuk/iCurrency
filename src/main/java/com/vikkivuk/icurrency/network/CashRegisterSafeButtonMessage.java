...
public record CashRegisterSafeButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) implements CustomPacketPayload {
	...
	public static final Type<CashRegisterSafeButtonMessage> TYPE = new Type<>(new ResourceLocation(IcurrencyMod.MODID, "cash_register_safe_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		IcurrencyMod.addNetworkMessage(CashRegisterSafeButtonMessage.TYPE, CashRegisterSafeButtonMessage.STREAM_CODEC, CashRegisterSafeButtonMessage::handleData);
	}
}
