...
public record CashRegisterPayCashButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) implements CustomPacketPayload {
	...
	public static final Type<CashRegisterPayCashButtonMessage> TYPE = new Type<>(new ResourceLocation(IcurrencyMod.MODID, "cash_register_pay_cash_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		IcurrencyMod.addNetworkMessage(CashRegisterPayCashButtonMessage.TYPE, CashRegisterPayCashButtonMessage.STREAM_CODEC, CashRegisterPayCashButtonMessage::handleData);
	}
}
