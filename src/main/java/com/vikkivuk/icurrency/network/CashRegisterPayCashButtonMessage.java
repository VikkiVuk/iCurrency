...
import com.vikkivuk.icurrency.procedures.PayCashCashRegisterProcedure;
...
public record CashRegisterPayCashButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(IcurrencyMod.MODID, "cash_register_pay_cash_buttons");

	public CashRegisterPayCashButtonMessage(FriendlyByteBuf buffer) {
	...
	public static void handleData(final CashRegisterPayCashButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		IcurrencyMod.addNetworkMessage(CashRegisterPayCashButtonMessage.ID, CashRegisterPayCashButtonMessage::new, CashRegisterPayCashButtonMessage::handleData);
	}
