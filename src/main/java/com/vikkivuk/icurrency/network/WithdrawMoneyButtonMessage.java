...
public record WithdrawMoneyButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) implements CustomPacketPayload {
	...
	public static final Type<WithdrawMoneyButtonMessage> TYPE = new Type<>(new ResourceLocation(IcurrencyMod.MODID, "withdraw_money_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		IcurrencyMod.addNetworkMessage(WithdrawMoneyButtonMessage.TYPE, WithdrawMoneyButtonMessage.STREAM_CODEC, WithdrawMoneyButtonMessage::handleData);
	}
}
