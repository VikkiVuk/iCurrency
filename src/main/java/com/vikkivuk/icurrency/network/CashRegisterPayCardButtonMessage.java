...
import com.vikkivuk.icurrency.procedures.VoidTransactionProcedure;
import com.vikkivuk.icurrency.procedures.SwipeCardCashRegisterProcedure;
...
public record CashRegisterPayCardButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(IcurrencyMod.MODID, "cash_register_pay_card_buttons");

	public CashRegisterPayCardButtonMessage(FriendlyByteBuf buffer) {
	...
	public static void handleData(final CashRegisterPayCardButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		IcurrencyMod.addNetworkMessage(CashRegisterPayCardButtonMessage.ID, CashRegisterPayCardButtonMessage::new, CashRegisterPayCardButtonMessage::handleData);
	}
