...
public record CashRegisterPayCardButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) implements CustomPacketPayload {
	...
	public static final Type<CashRegisterPayCardButtonMessage> TYPE = new Type<>(new ResourceLocation(IcurrencyMod.MODID, "cash_register_pay_card_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		IcurrencyMod.addNetworkMessage(CashRegisterPayCardButtonMessage.TYPE, CashRegisterPayCardButtonMessage.STREAM_CODEC, CashRegisterPayCardButtonMessage::handleData);
	}
}
