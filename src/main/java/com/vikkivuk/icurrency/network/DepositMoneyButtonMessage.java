...
public record DepositMoneyButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(IcurrencyMod.MODID, "deposit_money_buttons");

	public DepositMoneyButtonMessage(FriendlyByteBuf buffer) {
	...
	public static void handleData(final DepositMoneyButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		IcurrencyMod.addNetworkMessage(DepositMoneyButtonMessage.ID, DepositMoneyButtonMessage::new, DepositMoneyButtonMessage::handleData);
	}
