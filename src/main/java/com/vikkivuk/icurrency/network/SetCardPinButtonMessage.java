...
import com.vikkivuk.icurrency.procedures.SetCardPinConfirmProcedure;
...
public record SetCardPinButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) implements CustomPacketPayload {
	...
	public static final Type<SetCardPinButtonMessage> TYPE = new Type<>(new ResourceLocation(IcurrencyMod.MODID, "set_card_pin_buttons"));
	...
	}, (RegistryFriendlyByteBuf buffer) -> new SetCardPinButtonMessage(buffer.readInt(), buffer.readInt(), buffer.readInt(), buffer.readInt(), readTextState(buffer)));
	@Override
	public Type<SetCardPinButtonMessage> type() {
		return TYPE;
	}

	public static void handleData(final SetCardPinButtonMessage message, final IPayloadContext context) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z, HashMap<String, String> textstate) {
		...
		HashMap guistate = SetCardPinMenu.guistate;
		...
		if (buttonID == 0) {
			...
			SetCardPinConfirmProcedure.execute(world, entity, guistate);
		}
	}
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		IcurrencyMod.addNetworkMessage(SetCardPinButtonMessage.TYPE, SetCardPinButtonMessage.STREAM_CODEC, SetCardPinButtonMessage::handleData);
	}
}
