...
import com.vikkivuk.icurrency.procedures.ExchangeMoneyPressedProcedure;
...
public record ExchangeMoneyButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) implements CustomPacketPayload {
	...
	public static final Type<ExchangeMoneyButtonMessage> TYPE = new Type<>(new ResourceLocation(IcurrencyMod.MODID, "exchange_money_buttons"));
	...
	}, (RegistryFriendlyByteBuf buffer) -> new ExchangeMoneyButtonMessage(buffer.readInt(), buffer.readInt(), buffer.readInt(), buffer.readInt(), readTextState(buffer)));
	@Override
	public Type<ExchangeMoneyButtonMessage> type() {
		return TYPE;
	}

	public static void handleData(final ExchangeMoneyButtonMessage message, final IPayloadContext context) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z, HashMap<String, String> textstate) {
		...
		HashMap guistate = ExchangeMoneyMenu.guistate;
		...
		if (buttonID == 0) {
			...
			ExchangeMoneyPressedProcedure.execute(entity);
		}
	}
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		IcurrencyMod.addNetworkMessage(ExchangeMoneyButtonMessage.TYPE, ExchangeMoneyButtonMessage.STREAM_CODEC, ExchangeMoneyButtonMessage::handleData);
	}
}
