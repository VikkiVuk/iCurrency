...
public record EnterPinButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) implements CustomPacketPayload {
	...
	public static final Type<EnterPinButtonMessage> TYPE = new Type<>(new ResourceLocation(IcurrencyMod.MODID, "enter_pin_buttons"));
	...
	}, (RegistryFriendlyByteBuf buffer) -> new EnterPinButtonMessage(buffer.readInt(), buffer.readInt(), buffer.readInt(), buffer.readInt(), readTextState(buffer)));
	@Override
	public Type<EnterPinButtonMessage> type() {
		return TYPE;
	}

	public static void handleData(final EnterPinButtonMessage message, final IPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		IcurrencyMod.addNetworkMessage(EnterPinButtonMessage.TYPE, EnterPinButtonMessage.STREAM_CODEC, EnterPinButtonMessage::handleData);
	}
}
