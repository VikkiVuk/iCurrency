...
public record AcknowledgeTransactionResultCRButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(IcurrencyMod.MODID, "acknowledge_transaction_result_cr_buttons");

	public AcknowledgeTransactionResultCRButtonMessage(FriendlyByteBuf buffer) {
	...
	public static void handleData(final AcknowledgeTransactionResultCRButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		IcurrencyMod.addNetworkMessage(AcknowledgeTransactionResultCRButtonMessage.ID, AcknowledgeTransactionResultCRButtonMessage::new, AcknowledgeTransactionResultCRButtonMessage::handleData);
	}
