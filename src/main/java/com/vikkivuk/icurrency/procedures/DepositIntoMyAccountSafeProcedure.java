	...
	public static void execute(Entity entity) {
		...
		for (int index0 = 0; index0 < 9; index0++) {
			if ((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get((int) current_slot)).getItem() : ItemStack.EMPTY)
					.getItem() == IcurrencyModItems.DOLLAR_THOUSAND.get()) {
				total = total + new Object() {
					...
					.getItem() == IcurrencyModItems.DOLLAR_FIVE_HUNDRED.get()) {
				total = total + new Object() {
					public int getAmount(int sltid) {
						if (entity instanceof Player _player && _player.containerMenu instanceof Supplier _current && _current.get() instanceof Map _slots) {
							ItemStack stack = ((Slot) _slots.get(sltid)).getItem();
					...
					.getItem() == IcurrencyModItems.DOLLAR_TWO_HUNDRED.get()) {
				total = total + new Object() {
					public int getAmount(int sltid) {
						if (entity instanceof Player _player && _player.containerMenu instanceof Supplier _current && _current.get() instanceof Map _slots) {
							ItemStack stack = ((Slot) _slots.get(sltid)).getItem();
					...
					.getItem() == IcurrencyModItems.DOLLAR_HUNDRED.get()) {
				total = total + new Object() {
					public int getAmount(int sltid) {
						if (entity instanceof Player _player && _player.containerMenu instanceof Supplier _current && _current.get() instanceof Map _slots) {
							ItemStack stack = ((Slot) _slots.get(sltid)).getItem();
					...
					.getItem() == IcurrencyModItems.DOLLAR_FIFTY.get()) {
				total = total + new Object() {
					public int getAmount(int sltid) {
						if (entity instanceof Player _player && _player.containerMenu instanceof Supplier _current && _current.get() instanceof Map _slots) {
							ItemStack stack = ((Slot) _slots.get(sltid)).getItem();
					...
					.getItem() == IcurrencyModItems.DOLLAR_TWENTY.get()) {
				total = total + new Object() {
					public int getAmount(int sltid) {
						if (entity instanceof Player _player && _player.containerMenu instanceof Supplier _current && _current.get() instanceof Map _slots) {
							ItemStack stack = ((Slot) _slots.get(sltid)).getItem();
					...
					.getItem() == IcurrencyModItems.DOLLAR_TEN.get()) {
				total = total + new Object() {
					public int getAmount(int sltid) {
						if (entity instanceof Player _player && _player.containerMenu instanceof Supplier _current && _current.get() instanceof Map _slots) {
							ItemStack stack = ((Slot) _slots.get(sltid)).getItem();
		...
		}
		{
			...
			_vars.money = entity.getData(IcurrencyModVariables.PLAYER_VARIABLES).money + total;
