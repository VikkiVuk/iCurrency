...
public class IcurrencyMod {
	...
	public IcurrencyMod(IEventBus modEventBus) {
		...
		IcurrencyModItems.register(modEventBus);
	...
	public static class TextboxSetMessage implements CustomPacketPayload {
		public static final ResourceLocation ID = new ResourceLocation(IcurrencyMod.MODID, "textbox_set_value");
	...
	public static class Inittextbox {
		...
		public static void init(FMLCommonSetupEvent event) {
			IcurrencyMod.addNetworkMessage(TextboxSetMessage.ID, TextboxSetMessage::new, TextboxSetMessage::handleData);
		}
	}
