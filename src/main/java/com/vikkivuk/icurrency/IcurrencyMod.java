package com.vikkivuk.icurrency;
...
import com.vikkivuk.icurrency.init.IcurrencyModTabs;
import com.vikkivuk.icurrency.init.IcurrencyModMenus;
import com.vikkivuk.icurrency.init.IcurrencyModItems;
import com.vikkivuk.icurrency.init.IcurrencyModBlocks;
import com.vikkivuk.icurrency.init.IcurrencyModBlockEntities;

@Mod("icurrency")
public class IcurrencyMod {
	public static final Logger LOGGER = LogManager.getLogger(IcurrencyMod.class);
	public static final String MODID = "icurrency";

	public IcurrencyMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		IcurrencyModBlocks.REGISTRY.register(modEventBus);
		IcurrencyModBlockEntities.REGISTRY.register(modEventBus);
		IcurrencyModItems.REGISTRY.register(modEventBus);

		IcurrencyModTabs.REGISTRY.register(modEventBus);
		IcurrencyModVariables.ATTACHMENT_TYPES.register(modEventBus);

		IcurrencyModMenus.REGISTRY.register(modEventBus);
	...
	public static record GuiSyncMessage(String editbox, String value) implements CustomPacketPayload {
		public static final Type<GuiSyncMessage> TYPE = new Type<>(new ResourceLocation(IcurrencyMod.MODID, "gui_sync"));
						...
						for (Field field : fields) {
							if (EditBox.class.isAssignableFrom(field.getType())) {
								try {
									...
									IcurrencyMod.LOGGER.error(exceptionAsString);
								}
							}
						}
					}
	...
	public static class GuiSyncInit {
		...
		public static void init(FMLCommonSetupEvent event) {
			IcurrencyMod.addNetworkMessage(GuiSyncMessage.TYPE, GuiSyncMessage.STREAM_CODEC, GuiSyncMessage::handleData);
		}
	}
}
