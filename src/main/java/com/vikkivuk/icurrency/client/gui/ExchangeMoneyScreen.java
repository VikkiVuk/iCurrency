...
import com.vikkivuk.icurrency.network.ExchangeMoneyButtonMessage;
...
public class ExchangeMoneyScreen extends AbstractContainerScreen<ExchangeMoneyMenu> {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.icurrency.exchange_money.label_exchange_money"), 7, 7, -12829636, false);
	}
