...
import com.vikkivuk.icurrency.network.EnterPinButtonMessage;
...
public class EnterPinScreen extends AbstractContainerScreen<EnterPinMenu> {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.icurrency.enter_pin.label_set_card_pin"), 33, 9, -12829636, false);
	}

	@Override
	public void init() {
		super.init();
		pin = new EditBox(this.font, this.leftPos + 12, this.topPos + 24, 118, 18, Component.translatable("gui.icurrency.enter_pin.pin")) {
			@Override
			public void insertText(String text) {
				super.insertText(text);
				if (getValue().isEmpty())
					setSuggestion(Component.translatable("gui.icurrency.enter_pin.pin").getString());
				else
					setSuggestion(null);
			}
		...
		pin.setSuggestion(Component.translatable("gui.icurrency.enter_pin.pin").getString());
