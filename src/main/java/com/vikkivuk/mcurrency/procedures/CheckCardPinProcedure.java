...
public class CheckCardPinProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, HashMap guistate) {
		if (entity == null || guistate == null)
			return;
		McurrencyMod.queueServerWork(1, () -> {
			...
			if ((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get(0)).getItem() : ItemStack.EMPTY)
				...
				if (((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get(0)).getItem() : ItemStack.EMPTY)
					...
					if ((entity.getDisplayName().getString()).equals((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get(0)).getItem() : ItemStack.EMPTY)
						...
						if (entity.getData(McurrencyModVariables.PLAYER_VARIABLES).cards.containsValue((new Vec3(
							...
							if (new Object() {
							...
							}.getValue(world, BlockPos.containing(x, y, z), "total") <= entity.getData(McurrencyModVariables.PLAYER_VARIABLES).money) {
								if (!(((new BiFunction<LevelAccessor, String, Entity>() {
									...
									{
										McurrencyModVariables.PlayerVariables _vars = ((new BiFunction<LevelAccessor, String, Entity>() {
											@Override
											public Entity apply(LevelAccessor levelAccessor, String uuid) {
												if (levelAccessor instanceof ServerLevel serverLevel) {
													try {
										...
										}.getValue(world, BlockPos.containing(x, y, z), "cashier_uuid")))).getData(McurrencyModVariables.PLAYER_VARIABLES);
										...
										}.getValue(world, BlockPos.containing(x, y, z), "cashier_uuid")))).getData(McurrencyModVariables.PLAYER_VARIABLES).money + (new Object() {
											public double getValue(LevelAccessor world, BlockPos pos, String tag) {
												BlockEntity blockEntity = world.getBlockEntity(pos);
												if (blockEntity != null)
													return blockEntity.getPersistentData().getDouble(tag);
						...
						if (!(((new BiFunction<LevelAccessor, String, Entity>() {
							...
							if (((new BiFunction<LevelAccessor, String, Entity>() {
								...
								public Entity apply(LevelAccessor levelAccessor, String uuid) {
									...
									.getData(McurrencyModVariables.PLAYER_VARIABLES).cards
								...
								if (new Object() {
									...
									public Entity apply(LevelAccessor levelAccessor, String uuid) {
										...
										.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag().getString("holder_uuid")))).getData(McurrencyModVariables.PLAYER_VARIABLES).money) {
									if (!(((new BiFunction<LevelAccessor, String, Entity>() {
										@Override
										public Entity apply(LevelAccessor levelAccessor, String uuid) {
											if (levelAccessor instanceof ServerLevel serverLevel) {
									...
									}.getValue(world, BlockPos.containing(x, y, z), "cashier_uuid")))) == null)) {
										{
											McurrencyModVariables.PlayerVariables _vars = ((new BiFunction<LevelAccessor, String, Entity>() {
												...
												public Entity apply(LevelAccessor levelAccessor, String uuid) {
													...
													.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag().getString("holder_uuid")))).getData(McurrencyModVariables.PLAYER_VARIABLES);
											_vars.money = ((new BiFunction<LevelAccessor, String, Entity>() {
												@Override
												public Entity apply(LevelAccessor levelAccessor, String uuid) {
													if (levelAccessor instanceof ServerLevel serverLevel) {
													...
													.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag().getString("holder_uuid")))).getData(McurrencyModVariables.PLAYER_VARIABLES).money - (new Object() {
														public double getValue(LevelAccessor world, BlockPos pos, String tag) {
															BlockEntity blockEntity = world.getBlockEntity(pos);
															if (blockEntity != null)
																return blockEntity.getPersistentData().getDouble(tag);
