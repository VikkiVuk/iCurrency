...
import com.vikkivuk.mcurrency.network.CashRegisterOverviewButtonMessage;
...
public class CashRegisterOverviewScreen extends AbstractContainerScreen<CashRegisterOverviewMenu> {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("mcurrency:textures/screens/cash_register_overview.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.mcurrency.cash_register_overview.label_welcome"), 16, 12, -12829636, false);
	}

	@Override
	public void init() {
		super.init();
		button_empty = Button.builder(Component.translatable("gui.mcurrency.cash_register_overview.button_empty"), e -> {
			if (true) {
		...
		button_empty1 = Button.builder(Component.translatable("gui.mcurrency.cash_register_overview.button_empty1"), e -> {
			if (true) {
