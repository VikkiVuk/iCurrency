...
import com.vikkivuk.mcurrency.network.CashRegisterPayCashButtonMessage;
...
public class CashRegisterPayCashScreen extends AbstractContainerScreen<CashRegisterPayCashMenu> {
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 147 && mouseX < leftPos + 171 && mouseY > topPos + 4 && mouseY < topPos + 28)
			guiGraphics.renderTooltip(font, Component.translatable("gui.mcurrency.cash_register_pay_cash.tooltip_void_the_transaction"), mouseX, mouseY);
	}
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.mcurrency.cash_register_pay_cash.label_cash_payment"), 7, 8, -12829636, false);
	...
	public void init() {
		super.init();
		button_empty = Button.builder(Component.translatable("gui.mcurrency.cash_register_pay_cash.button_empty"), e -> {
			if (true) {
