package com.vikkivuk.mcurrency;
...
import com.vikkivuk.mcurrency.init.McurrencyModTabs;
import com.vikkivuk.mcurrency.init.McurrencyModMenus;
import com.vikkivuk.mcurrency.init.McurrencyModItems;
import com.vikkivuk.mcurrency.init.McurrencyModBlocks;
import com.vikkivuk.mcurrency.init.McurrencyModBlockEntities;

@Mod("mcurrency")
public class McurrencyMod {
	public static final Logger LOGGER = LogManager.getLogger(McurrencyMod.class);
	public static final String MODID = "mcurrency";

	public McurrencyMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		McurrencyModBlocks.REGISTRY.register(modEventBus);
		McurrencyModBlockEntities.REGISTRY.register(modEventBus);
		McurrencyModItems.REGISTRY.register(modEventBus);

		McurrencyModTabs.REGISTRY.register(modEventBus);
		McurrencyModVariables.ATTACHMENT_TYPES.register(modEventBus);

		McurrencyModMenus.REGISTRY.register(modEventBus);
						...
						for (Field field : fields) {
							if (EditBox.class.isAssignableFrom(field.getType())) {
								try {
									...
									McurrencyMod.LOGGER.error(exceptionAsString);
								}
							}
						}
					}
	...
	public static class GuiSyncInit {
		...
		public static void init(FMLCommonSetupEvent event) {
			McurrencyMod.addNetworkMessage(GuiSyncMessage.TYPE, GuiSyncMessage.STREAM_CODEC, GuiSyncMessage::handleData);
		}
	}
}
