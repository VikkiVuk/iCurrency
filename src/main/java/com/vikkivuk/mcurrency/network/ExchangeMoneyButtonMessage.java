...
import com.vikkivuk.mcurrency.procedures.ExchangeMoneyPressedProcedure;
...
public record ExchangeMoneyButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) implements CustomPacketPayload {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		McurrencyMod.addNetworkMessage(ExchangeMoneyButtonMessage.TYPE, ExchangeMoneyButtonMessage.STREAM_CODEC, ExchangeMoneyButtonMessage::handleData);
	}
}
