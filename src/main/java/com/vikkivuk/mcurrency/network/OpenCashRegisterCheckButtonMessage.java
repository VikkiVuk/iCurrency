...
import com.vikkivuk.mcurrency.procedures.OpenCashRegisterCheckCheckProcedure;
...
public record OpenCashRegisterCheckButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) implements CustomPacketPayload {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		McurrencyMod.addNetworkMessage(OpenCashRegisterCheckButtonMessage.TYPE, OpenCashRegisterCheckButtonMessage.STREAM_CODEC, OpenCashRegisterCheckButtonMessage::handleData);
	}
}
