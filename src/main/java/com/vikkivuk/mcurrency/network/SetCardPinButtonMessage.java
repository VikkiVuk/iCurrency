...
import com.vikkivuk.mcurrency.procedures.SetCardPinConfirmProcedure;
...
public record SetCardPinButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) implements CustomPacketPayload {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		McurrencyMod.addNetworkMessage(SetCardPinButtonMessage.TYPE, SetCardPinButtonMessage.STREAM_CODEC, SetCardPinButtonMessage::handleData);
	}
}
