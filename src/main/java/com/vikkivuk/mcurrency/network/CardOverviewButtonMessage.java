...
import com.vikkivuk.mcurrency.procedures.TrashCardTwoProcedure;
import com.vikkivuk.mcurrency.procedures.TrashCardThreeProcedure;
import com.vikkivuk.mcurrency.procedures.TrashCardOneProcedure;
import com.vikkivuk.mcurrency.procedures.TrashCardFourProcedure;
import com.vikkivuk.mcurrency.procedures.RequestCardClickedProcedure;
...
public record CardOverviewButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) implements CustomPacketPayload {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		McurrencyMod.addNetworkMessage(CardOverviewButtonMessage.TYPE, CardOverviewButtonMessage.STREAM_CODEC, CardOverviewButtonMessage::handleData);
	}
}
