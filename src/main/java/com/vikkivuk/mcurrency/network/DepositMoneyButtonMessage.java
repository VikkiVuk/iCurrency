...
import com.vikkivuk.mcurrency.procedures.DepositMoneyClickedProcedure;
...
public record DepositMoneyButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) implements CustomPacketPayload {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		McurrencyMod.addNetworkMessage(DepositMoneyButtonMessage.TYPE, DepositMoneyButtonMessage.STREAM_CODEC, DepositMoneyButtonMessage::handleData);
	}
}
