...
import com.vikkivuk.mcurrency.procedures.CheckCardPinProcedure;
...
public record EnterPinButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) implements CustomPacketPayload {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		McurrencyMod.addNetworkMessage(EnterPinButtonMessage.TYPE, EnterPinButtonMessage.STREAM_CODEC, EnterPinButtonMessage::handleData);
	}
}
